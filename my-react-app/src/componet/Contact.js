        ...
        <div className="main-box">
            ...
            <form id="form" onSubmit={formsubmit}>
                <div className="form-group">
                    ...
                    <small id="usererror" className="error">User name is not vaild</small>
                </div>
                <div className="form-group">
                    ...
                    <small id="usererror" className="error">Email is not vaild</small>
                </div>
                <div className="form-group">
                    ...
                    <small id="usererror" className="error">Password is not vaild</small>
                </div>
                {/* <div className="form-group">
                ...
                <div className="form-group">
                    ...
                    <small id="usererror" className="error">Number is not vaild</small>
                </div>
                <div className="form-group">
